...
def generate_test_description():
    ...
    add_analyzer = ExecuteProcess(
        cmd=[
            ...
            "--ros-args",
            "--params-file",
            "/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/all_analyzers.yaml",
            "--log-level",
            "DEBUG"
            ],
        name='add_analyzer',
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, aggregator_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/expected_output/add_all_analyzers"),
