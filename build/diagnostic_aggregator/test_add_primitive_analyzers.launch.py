...
def generate_test_description():
    ...
    aggregator_node = ExecuteProcess(
        cmd=[
            "/home/szk/workspace/car_distributed/car_agent/install/diagnostic_aggregator/lib/diagnostic_aggregator/aggregator_node",
            "--ros-args",
            "--params-file",
            "/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/default.yaml",
            "--log-level",
            "DEBUG"
            ],
    ...
    add_analyzer = ExecuteProcess(
        cmd=[
            "/home/szk/workspace/car_distributed/car_agent/install/diagnostic_aggregator/lib/diagnostic_aggregator/add_analyzer",
            "--ros-args",
            "--params-file",
            "/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/primitive_analyzers.yaml",
            "--log-level",
            "DEBUG"
            ],
        name='add_analyzer',
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, aggregator_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/expected_output/add_primitive_analyzers"),
