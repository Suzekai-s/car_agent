...
test_listener = ExecuteProcess(
    cmd=[
        "/usr/bin/python3",
        "/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/test_listener.py"
        ],
    name='test_listener',
    emulate_tty=True,
    output='screen')
...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, launch_service, proc_info, proc_output):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/expected_output/output_primitive_analyzers"),
