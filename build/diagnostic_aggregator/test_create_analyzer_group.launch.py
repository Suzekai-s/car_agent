...
class TestAggregator(unittest.TestCase):
    ...
    def test_processes_output(self, proc_output, aggregator_node):
        ...
        proc_output.assertWaitFor(
            expected_output=launch_testing.tools.expected_output_from_file(path="/home/szk/workspace/car_distributed/car_agent/src/diagnostics/diagnostic_aggregator/test/expected_output/create_analyzer_group"),
